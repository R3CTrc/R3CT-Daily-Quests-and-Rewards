...
public class DailyFabric implements ModInitializer {
	...
	public void onInitialize() {
		...
		PayloadTypeRegistry.playS2C().register(com.r3ct.daily.network.OpenRewardsPayload.ID, com.r3ct.daily.network.OpenRewardsPayload.CODEC);
		PayloadTypeRegistry.playS2C().register(com.r3ct.daily.network.OpenQuestsPayload.ID, com.r3ct.daily.network.OpenQuestsPayload.CODEC);
		PayloadTypeRegistry.playS2C().register(com.r3ct.daily.network.SyncQuestsPayload.ID, com.r3ct.daily.network.SyncQuestsPayload.CODEC);

		PayloadTypeRegistry.playC2S().register(com.r3ct.daily.network.RequestLeaderboardPayload.ID, com.r3ct.daily.network.RequestLeaderboardPayload.CODEC);
		PayloadTypeRegistry.playS2C().register(com.r3ct.daily.network.LeaderboardResponsePayload.ID, com.r3ct.daily.network.LeaderboardResponsePayload.CODEC);
		...
		PayloadTypeRegistry.playC2S().register(com.r3ct.daily.network.RerollQuestPayload.ID, com.r3ct.daily.network.RerollQuestPayload.CODEC);
