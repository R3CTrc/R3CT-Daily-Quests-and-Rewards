...
public class DailyFabric implements ModInitializer {
	...
	private static com.r3ct.daily.network.LeaderboardResponsePayload cachedQuestsBoard = null;
	private static com.r3ct.daily.network.LeaderboardResponsePayload cachedRewardsBoard = null;
	...
	public void onInitialize() {
		...
		ServerPlayNetworking.registerGlobalReceiver(com.r3ct.daily.network.RequestLeaderboardPayload.ID, (payload, context) -> {
			context.server().execute(() -> {
				...
				if (lastLeaderboardUpdateTick == -1 || (currentTick - lastLeaderboardUpdateTick) >= DailyServerConfig.mechanics.technical.leaderboardUpdateIntervalTicks) {
		...
		ServerEntityLevelChangeEvents.AFTER_PLAYER_CHANGE_LEVEL.register((player, origin, destination) -> {
			...
			if (!data.unlockedDimensions.contains(dimId)) {
				...
				player.sendSystemMessage(Component.translatable("r3ct.message.dimension_discovered", "§d" + dimName));
			...
			if (data.unlockedDimensions.contains("minecraft:overworld") &&
				...
				QuestManager.grantAdvancement((ServerPlayer) player, "r3ct_daily:quests/dimension_master");
			}
		});
			...
			dispatcher.register(Commands.literal("daily")
							...
							.then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player())
									.then(Commands.literal("all").executes(context -> {
										...
										if (anyCompleted) {
											...
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.forcecomplete.all_already_done", "§e" + target.getName().getString()), false);
										}
										return 1;
									}))
									.then(Commands.argument("index", IntegerArgumentType.integer(1, 5)).executes(context -> {
										...
										if (success) {
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.forcecomplete.single_success", "§e" + (index + 1), "§e" + target.getName().getString()), true);
										} else {
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.forcecomplete.single_already_done", "§e" + (index + 1), "§e" + target.getName().getString()), false);
										}
										return 1;
									}))
							)
					...
					.then(Commands.literal("admin")
							...
							.then(Commands.literal("reset_cooldown")
									.then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player())
											.executes(context -> {
												...
												syncPlayerData(target, data);
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.reset_cooldown.success", "§e" + target.getName().getString()), true);
												return 1;
											})
									)
							)
							.then(Commands.literal("points")
									.then(Commands.literal("add").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(1)).executes(context -> {
										...
										syncPlayerData(target, data);
										context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.points.add", "§d" + amount, "§e" + target.getName().getString(), "§d" + data.totalQuestPoints), true);
										return 1;
									}))))
									.then(Commands.literal("set").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(0)).executes(context -> {
										...
										data.totalQuestPoints = amount;
										syncPlayerData(target, data);
										context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.points.set", "§d" + amount, "§e" + target.getName().getString()), true);
										return 1;
									}))))
									.then(Commands.literal("remove").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(1)).executes(context -> {
										...
										syncPlayerData(target, data);
										context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.points.remove", "§d" + amount, "§e" + target.getName().getString(), "§d" + data.totalQuestPoints), true);
										return 1;
									}))))
							)
							.then(Commands.literal("streak")
									.then(Commands.literal("set")
											.then(Commands.literal("quests").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(0)).executes(context -> {
												...
												syncPlayerData(target, data);
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.streak.quests", "§e" + target.getName().getString(), "§e" + amount), true);
												return 1;
											}))))
											.then(Commands.literal("rewards").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(0)).executes(context -> {
												...
												data.streak = amount;
												syncPlayerData(target, data);
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.streak.rewards", "§e" + target.getName().getString(), "§e" + amount), true);
												return 1;
											}))))
									)
							)
							.then(Commands.literal("shields")
									.then(Commands.literal("set")
											.then(Commands.literal("quests").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(0)).executes(context -> {
												...
												syncPlayerData(target, data);
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.shields.quests", "§e" + target.getName().getString(), "§b" + amount), true);
												return 1;
											}))))
											.then(Commands.literal("rewards").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("amount", IntegerArgumentType.integer(0)).executes(context -> {
												ServerPlayer target = net.minecraft.commands.arguments.EntityArgument.getPlayer(context, "target");
												...
												syncPlayerData(target, data);
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.shields.rewards", "§e" + target.getName().getString(), "§b" + amount), true);
												return 1;
											}))))
									)
							)
							.then(Commands.literal("dimensions")
									.then(Commands.literal("unlock").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("dim", com.mojang.brigadier.arguments.StringArgumentType.word()).executes(context -> {
										...
										if (!data.unlockedDimensions.contains(dim)) {
											...
											syncPlayerData(target, data);
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.dimensions.unlock.success", "§d" + dim, "§e" + target.getName().getString()), true);
										} else {
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.dimensions.unlock.fail", "§e" + target.getName().getString(), "§d" + dim), false);
										}
										return 1;
									}))))
									.then(Commands.literal("revoke").then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player()).then(Commands.argument("dim", com.mojang.brigadier.arguments.StringArgumentType.word()).executes(context -> {
										...
										if (data.unlockedDimensions.contains(dim)) {
											...
											syncPlayerData(target, data);
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.dimensions.revoke.success", "§d" + dim, "§e" + target.getName().getString()), true);
										} else {
											context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.dimensions.revoke.fail", "§e" + target.getName().getString(), "§d" + dim), false);
										}
										return 1;
									}))))
							)
							.then(Commands.literal("clear_data")
									.then(Commands.argument("target", net.minecraft.commands.arguments.EntityArgument.player())
											.executes(context -> {
												...
												context.getSource().sendSuccess(() -> Component.translatable("r3ct.command.admin.clear_data.success", "§e" + target.getName().getString()), true);
												return 1;
											})
									)
							)
					...
					.then(Commands.literal("quests")
							.executes(context -> {
								...
								ServerPlayNetworking.send(player, new com.r3ct.daily.network.OpenQuestsPayload(
										data.questStreak,
					...
					.then(Commands.literal("rewards")
							.executes(context -> {
								...
								ServerPlayNetworking.send(player, new com.r3ct.daily.network.OpenRewardsPayload(
										data.rewardDay,
										data.lastRewardDate,
										visualStreak,
										data.totalCollected,
					...
					.then(Commands.literal("claimreward")
							.executes(context -> {
								...
								if (data.streak == 7) {
									QuestManager.grantAdvancement(player, "r3ct_daily:rewards/always_on_time");
								}
								...
								for (ItemStack rewardStack : rewards) {
									...
									String itemNameStr = rewardStack.getHoverName().getString();
									QuestManager.giveOrDrop(player, rewardStack);
									player.sendSystemMessage(Component.translatable("r3ct.message.rewards.received", "§b" + amount, "§b" + itemNameStr));
									if (!historyBuilder.isEmpty()) historyBuilder.append(", ");
									historyBuilder.append("§a").append(amount).append("x ").append(itemNameStr);
								}
								...
								if (data.totalCollected >= 50) {
									QuestManager.grantAdvancement(player, "r3ct_daily:rewards/login_veteran");
								}
								if (data.rewardDay == 7) {
		...
		net.fabricmc.fabric.api.event.player.PlayerBlockBreakEvents.AFTER.register((world, playerWorld, pos, state, blockEntity) -> {
			if (playerWorld instanceof ServerPlayer serverPlayer) {
				...
				if (state.is(net.minecraft.tags.BlockTags.JUNGLE_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:jungle_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.PALE_OAK_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:pale_oak_logs", 1);
				}
				if (blockId.contains("lapis_ore")) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:lapis_ores", 1);
				}
				...
				if (blockId.equals("minecraft:nether_quartz_ore")) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:nether_quartz_ores", 1);
				}
				...
				if (blockId.contains("diamond_ore")) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:diamond_ores", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.GOLD_ORES)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:gold_ores", 1);
				}
				...
				if (state.is(net.minecraft.tags.BlockTags.OAK_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:oak_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.BIRCH_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:birch_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.IRON_ORES)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:iron_ores", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.COPPER_ORES)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:copper_ores", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.ACACIA_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:acacia_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.DARK_OAK_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:dark_oak_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.MANGROVE_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:mangrove_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.SPRUCE_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:spruce_logs", 1);
				}
				if (state.is(net.minecraft.tags.BlockTags.CHERRY_LOGS)) {
					QuestManager.handleAction(serverPlayer, "BREAK_BLOCK", "r3ct_daily:cherry_logs", 1);
				}
	...
	private static void updateLeaderboardCache(net.minecraft.server.MinecraftServer server) {
		...
		cachedQuestsBoard = new com.r3ct.daily.network.LeaderboardResponsePayload(0, leftQ, rightQ);
	...
	private static void syncPlayerData(ServerPlayer target, PlayerData data) {
		...
		ServerPlayNetworking.send(target, new com.r3ct.daily.network.SyncQuestsPayload(
				data.questStreak, data.totalQuestPoints, data.dailyQuestsCompletedToday,
				data.activeQuests, data.questProgress, data.streak,
				data.perfectDaysCount, data.availableFreezes, data.availableRewardFreezes,
				data.questRewardsClaimed, data.claimedPointRewards
