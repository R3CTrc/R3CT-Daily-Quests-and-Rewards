...
public class DailyCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("daily")
                ...
                .then(Commands.literal("forcecomplete").requires(isOp).then(Commands.argument("target", EntityArgument.player())
                ...
                .then(Commands.literal("admin").requires(isOp)
                        .then(Commands.literal("reset_cooldown").then(Commands.argument("target", EntityArgument.player()).executes(context -> {
                            ServerPlayer target = EntityArgument.getPlayer(context, "target");
                ...
                .then(Commands.literal("claimreward").executes(context -> {
                    ...
                    for (ItemStack rewardStack : rewards) {
                        ...
                        player.sendSystemMessage(Component.translatable("r3ct.message.rewards.received", "§b" + amount, itemNameStr));
