...
public class GuiUtils {
    public static void drawRewardStyleBar(GuiGraphics g, Font font, int x, int y, float val, int max, String label, String valueText, int color, int bWidth, int tickStep, int[] labelsToDraw) {
        g.drawString(font, "§0" + label + ": " + valueText, x, y - 12, 0xFF000000, false);
        ...
        for (int p : labelsToDraw) {
            ...
            g.drawString(font, "§0" + pStr, tickX - (font.width(pStr) / 2), y + 13, 0xFF000000, false);
        }
    }
}